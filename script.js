    ...
    let game = () => {
        ...
        let playRound = (playerSelection, computerSelection) => {
            ...
            if (playerSelection === 'rock' && computerSelection === 'rock' ) {
                ...
                return result = 'You lose😭! Paper beats rock', computerScore++
            } else if (playerSelection === 'rock' && computerSelection === 'scissors') {
                return result = 'You win😎! Rock beats scissors', playerScore++
            } else if (playerSelection === 'paper' && computerSelection === 'rock') {
                return result = 'You win😎! Paper beats rock', playerScore++
            } else if (playerSelection === 'paper' && computerSelection === 'paper') {
                return result = 'Its a tie'
            } else if (playerSelection === 'paper' && computerSelection === 'scissors') {
                return result = 'You lose😭! Scissors beats paper', computerScore++
            } else if (playerSelection === 'scissors' && computerSelection === 'rock') {
                return result = 'You lose😭! Rock beats scissors', computerScore++
            } else if (playerSelection === 'scissors' && computerSelection === 'paper') {
                return result = 'You win😎! Scissors beats paper', playerScore++
